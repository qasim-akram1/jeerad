...
const AllMatchesHeader = () => {

  return (
    <section>
      <div className="content-5aw style-nw6ip" id="style-nw6ip">
        <button
          data-v-16581f12=""
          type="button"
          className="btn-mam icon-yoe btn-7t2 theme--mml fa-tx7"
        >
          <span className="content-h2a">
            <span data-v-16581f12="" className="icon-xoy theme--mml">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                role="img"
                aria-hidden="true"
                className="v-icon__svg snipcss0-7-7-8"
              >
        ...
        <div data-v-16581f12="" className="title-qmc header-f7f">
          All Matches
        </div>
        <div data-v-16581f12="" className="spa-yy3"></div>
        <div data-v-16581f12="" className="menu-xst"></div>
        <button type="button" className="btn-mam btn-ocw theme--mml fa-tx7">
          <span className="content-h2a">
            <span className="icon-xoy theme--mml style-Svo5b" id="style-Svo5b">
              <LanguageIcon />
            </span>
            <span className="pl-z44 toggleLanguageText">Select Language</span>
          </span>
        </button>
        <div data-v-16581f12="" className="menu-xst"></div>
        <button
          data-v-16581f12=""
          type="button"
          className="btn-mam btn-ocw theme--mml fa-tx7"
        >
          <span className="content-h2a">
            <span
              data-v-16581f12=""
              className="icon-xoy theme--mml style-scv9O"
              id="style-scv9O"
            >
              <ProfileIcon />
            </span>
