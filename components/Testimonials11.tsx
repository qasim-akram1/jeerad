...
const list: {
...
}[] = [
  {
    ...
    username: "John Doe",
    name: "John Doe",
    text: "Really easy to use. Locale helped me craft a professional CV effortlessly. The customizable templates and AI suggestions made my resume stand out. Highly recommended for anyone looking to impress recruiters!",
  ...
  },
  {
    username: "Jane Smith",
    name: "Jane Smith",
    text: "Creating a CV with Locale was a breeze! The variety of templates and intuitive interface made the process smooth. I landed my dream job thanks to my polished resume!",
    type: refTypes.twitter,
  ...
  },
  {
    ...
    name: "Michael Brown",
    text: "Locale's integration with LinkedIn saved me so much time. Importing my profile data seamlessly into the CV template was seamless. A fantastic tool for anyone serious about their career",
  ...
  },
  {
    username: "krishna",
    name: "Krishna Kant",
    text: "Finally a good boilerplate for Cv, now I dont have to cry about it.",
    type: refTypes.productHunt,
  ...
  {
    name: "Yazdun",
    text: "Yo Marc, I love how easy it was to customize my CV on Locale. The AI-powered suggestions helped me highlight my skills effectively. I've received positive feedback from recruiters ever since!",
    type: refTypes.other,
  },
  {
    name: "Marc Lou",
  ...
  // The last testimonial is featured on big devices (span 2 columns + big font) 👇
  {
    username: "VicPivots",
    name: "Victor Abeledo",
    text: "Locale's templates are not only stylish but also professional. The ability to personalize each section allowed me to tailor my CV precisely to different job applications. Definitely my go-to CV maker 🚀🚀🚀",
    type: refTypes.twitter,
